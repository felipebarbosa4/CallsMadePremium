...
public class Chap4_6e {
    public static void main(String[] args) {
        int custAreaCode;
        int selectAreaCode = 343;
        int custPhoneNumber;
        int numTxt;
        double taxes;
        ...
        while ((custAreaCode == selectAreaCode) && (custAreaCode != quit)) {
            ...
            if (numTxt > minTxt) {
                ...
                if (afterTaxCost > 10) {
                    System.out.printf("Area Code: [%d] Phone Number: [%d] Texts: %d Before Tax: $%.2f After Tax: $%.2f%n%n",
