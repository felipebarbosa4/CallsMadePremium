...
public class Chap4_7a_DriveRite {
    public static void main(String[] args) {
        ...
        System.out.print("Type the Policy Number Between 1000 and 9999: ");
        ...
        System.out.printf(">> Policy Number is : %d%n" ,policyNum); //Check if the IF Worked
